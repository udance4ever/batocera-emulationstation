                        ...
                        const float cornerRadius)
{
    ...
    drawTriangleStrips(vertices, 4, srcBlendFactor, dstBlendFactor);
        ...
        unsigned int Renderer::mixColors(unsigned int first, unsigned int second, float percent)                              
        {
	...
	// GuiComponent.cpp:108:24: error: no member named 'getScreenRect'
        ...
        Rect            Renderer::getScreenRect(const Transform4x4f& transform, const Vector3f& size, bool viewPort)
        {
